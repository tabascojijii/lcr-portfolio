...
def render_dockerfile(config: Dict) -> str:
    ...
    _validate_digest_pinned_image(base_image)
    context = {
...
def generate_dockerfile(config_source: Union[str, Dict], output_dir: str = str(IMAGE_DIR)) -> tuple[str, str]:
    ...
    constraints_path = out_path_obj / "constraints.txt"

    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(rendered)

    # Keep an explicit constraints file in build context.
    with open(constraints_path, 'w', encoding='utf-8') as f:
        f.write("# Generated by LCR. Add pins as needed for legacy reproducibility.\n")
